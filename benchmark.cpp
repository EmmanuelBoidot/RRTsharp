...
//    b.addPlanner(base::PlannerPtr(new geometric::RRTConnect(setup.getSpaceInformation())));
    ...
    b.addPlanner(base::PlannerPtr(new geometric::RRTstar(setup.getSpaceInformation())));
    b.addPlanner(base::PlannerPtr(new geometric::RRTsharp(setup.getSpaceInformation())));
...
//    b.addPlanner(base::PlannerPtr(new geometric::PRM(setup.getSpaceInformation())));
    ...
    req.maxTime = runtime_limit;
    req.maxMem = memory_limit;
